      ...
      {/* <section role="main">
        <div>
          ...
          <form>
            <div>
              <input
                aria-describedby="username-uid2-helper"
        ...
        <div data-i18n-or="or" data-i18n-continue="Or continue with:">
          <div>
            <div>
              <button type="button">
                <span>
        ...
        <div>
          <ul>
            <li>
              <a href="/login/resetpassword?application=trello&amp;continue=https%3A%2F%2Ftrello.com%2Fauth%2Fatlassian%2Fcallback%3Fdisplay%3DeyJ2ZXJpZmljYXRpb25TdHJhdGVneSI6InNvZnQifQ%253D%253D&amp;display=eyJ2ZXJpZmljYXRpb25TdHJhdGVneSI6InNvZnQifQ%3D%3D">
                Can't log in?
              </a>
            </li>
            <p>•</p>
            <li>
              <a href="/signup?application=trello&amp;continue=https%3A%2F%2Ftrello.com%2Fauth%2Fatlassian%2Fcallback%3Fdisplay%3DeyJ2ZXJpZmljYXRpb25TdHJhdGVneSI6InNvZnQifQ%253D%253D&amp;display=eyJ2ZXJpZmljYXRpb25TdHJhdGVneSI6InNvZnQifQ%3D%3D">
                Create an account
              </a>
            </li>
          </ul>
        ...
        <div>
          <footer>
            <span aria-label="Atlassian" role="img"></span>
            <div>
              One account for Trello, Jira, Confluence and
              <a
                target="_blank"
                rel="noreferrer noopener"
                aria-label="Learn more about Atlassian Account"
